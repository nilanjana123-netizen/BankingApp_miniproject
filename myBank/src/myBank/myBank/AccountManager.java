...
public class AccountManager {
	...
	public  AccountManager(Scanner scanner) {
		this.connection=connection;		this.scanner=scanner;
	}
...
//		double credit_amount=scanner.nextDouble();
...
//			double debit_amount=scanner.nextDouble();
//			System.out.println("Enter Security PIN:");
//			String security_pin=scanner.nextLine();
//			System.out.println("Total balance:");		
//	}
...
//		double receiver_account_number=scanner.nextDouble();
//		System.out.println("Enter the amount to be debited:");
//		double debit_amount=scanner.nextDouble();
//		System.out.println("Enter Security PIN:");
//		String security_pin=scanner.nextLine();	
